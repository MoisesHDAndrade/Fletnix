...
Vue.component('navbar',{
    props:[''],
    template: `<nav class="navbar navbar-expand-lg navbar-dark  sticky-top" style="background-color:rgba(0,0,0,0.3)">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu p-0 bg-dark bg-gradient" aria-labelledby="navbarDropdown">
        ...
        <form class="d-flex" method="POST" action="{% url 'movies:searcher' %}">
            {% csrf_token %}
